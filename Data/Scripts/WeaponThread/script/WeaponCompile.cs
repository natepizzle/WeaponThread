...
namespace WeaponThread
{
    partial class Weapons
    {
        ...
        internal Session.TrailDefinition Options(bool enable, string material, int decayTime, Vector4 color, bool back = false, float customWidth = 0, bool useWidthVariance = false)
        {
            return new Session.TrailDefinition { Enable = enable, Material = material, DecayTime = decayTime, Color = color, Back = back, CustomWidth = customWidth, UseWidthVariance = useWidthVariance};
        }
