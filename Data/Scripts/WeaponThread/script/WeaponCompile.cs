...
namespace WeaponThread
{
    partial class Weapons
    {
        ...
        internal Session.AimControlDefinition AimControl(bool trackTargets, bool turretAttached, bool turretController, bool primaryTracking, float rotateRate, float elevateRate, Vector3D offset, bool fixedOffset, float inventorySize, bool debug, int minAzimuth = -1, int maxAzimuth = -1, int minElevation = -1, int maxElevation = -1)
        {
