...
namespace WeaponThread
{
    partial class Weapons
    {
        ...
        internal Session.AimControlDefinition AimControl(bool trackTargets, bool turretAttached, bool turretController, float rotateRate, float elevateRate, bool primaryTracking = false, int minAzimuth = 0, int maxAzimuth = 0, int minElevation = 0, int maxElevation = 0, Vector3D offset = new Vector3D(), bool fixedOffset = false, float inventorySize = .384f, bool debug = false)
        {
