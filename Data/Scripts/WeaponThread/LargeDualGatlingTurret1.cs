    ...
    partial class Weapons
    {
        WeaponDefinition DualLargeGatlingTurret_KL_Turret1 => new WeaponDefinition
        {
            Assignments = new ModelAssignments
            {
                MountPoints = new[]
                {
                    MountPoint(subTypeId: "DualLargeGatlingTurret_KL", aimPartId:"", muzzlePartId: "GatlingBarrel1", azimuthPartId: "CoreTurret1", elevationPartId: "CoreBarrels1"),
                },
            ...
            {
                WeaponId = "Dual Gattling Turret 1", // name of weapon in terminal
                AmmoMagazineId = "NATO_25x184mm",
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, primaryTracking: true, rotateRate: 0.02f, elevateRate: 0.02f, minAzimuth: -180, maxAzimuth: 30, minElevation: -30, maxElevation: 80, offset: Vector(x: 0, y: .12, z: 0), fixedOffset: false, inventorySize: 0.34f, debug: false),
