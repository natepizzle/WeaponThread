...
{   // Don't edit above this line
    ...
    Assignments = new ModelAssignments
    {
        MountPoints = new[]
        {
            MountPoint(subTypeId: "GazerBeamLB", subPartId: "GazerBeamLenses"),
        },
    ...
    Targeting = new TargetingDefinition
    {
        ...
        MaxProjectileTargetSpeed = 70, //0 = ignores projectiles with health, double.MaxValue for no limit, sets max speed a projectile can travel before this weapon no longer targets them
    },
