...
{   // Don't edit above this line
    ...
    HardPoint = new HardPointDefinition
    {
        ...
        Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, primaryTracking: true, rotateRate: 0.04f, elevateRate: 0.04f, offset: Vector(x: 0, y: 0, z: 0), fixedOffset: false, debug: false),
        DeviateShotAngle = 0f,
