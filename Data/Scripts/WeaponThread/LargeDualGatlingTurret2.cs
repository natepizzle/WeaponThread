...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition DualLargeGatlingTurret_KL_Turret2 => new WeaponDefinition
        {
            Assignments = new ModelAssignments
            {
                MountPoints = new[]
                {
                    MountPoint(subTypeId: "DualLargeGatlingTurret_KL", aimPartId:"", muzzlePartId: "GatlingBarrel2", azimuthPartId: "CoreTurret2", elevationPartId: "CoreBarrels2"),
                },
                Barrels = Names("muzzle_projectile_007", "muzzle_projectile_008", "muzzle_projectile_009", "muzzle_projectile_010", "muzzle_projectile_011", "muzzle_projectile_012")
            },
            HardPoint = new HardPointDefinition
            {
                WeaponId = "Dual Gattling Turret 2", // name of weapon in terminal
                AmmoMagazineId = "NATO_25x184mm",
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, primaryTracking: false, rotateRate: 0.02f, elevateRate: 0.02f, minAzimuth: -30, maxAzimuth: 180, minElevation: -30, maxElevation: 80, offset: Vector(x: 0, y: .12, z: 0), fixedOffset: false, inventorySize: 0.34f, debug: false),
