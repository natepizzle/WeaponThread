    ...
    partial class Weapons
    {
        WeaponDefinition DronePod => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDefinition
            {
                ...
                MaxProjectileTargetSpeed = 0, //0 = ignores projectiles with health, double.MaxValue for no limit, sets max speed a projectile can travel before this weapon no longer targets them
            },
